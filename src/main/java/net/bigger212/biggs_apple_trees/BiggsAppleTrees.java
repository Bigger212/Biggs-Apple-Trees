...
public class BiggsAppleTrees implements ModInitializer {
    ...
    public void onInitialize() {
        LOGGER.info("Initializing biggs_apple_trees");
        ...
        // TODO Imersive Weathering compat.
        // TODO New tree shapes.
        // TODO Complete apple planks.
    ...
    public static class Config {
        ...
        public static int BLOOM_CHANCE = 26;
        ...
        public static void registerConfigs() {
            if (!CONFIG_FILE.exists()) {
                try {
                    ...
                    try (FileWriter writer = new FileWriter(CONFIG_FILE)) {
                        ...
                        writer.write("# Configuration for apple leaf growth and fruit yield.\n");
                        writer.write("#\n");

                        writer.write("# Default values yield ~17 apples per tree every 30 minutes.\n");
                        writer.write("# Lower values = faster fruit generation.\n");
                        writer.write("# Leaves have 3 stages: age 0, age 1 (flower), age 2 (fruit).#\n");

                        writer.write("# Chance per random tick for apple leaves to bloom.\n");
                        writer.write("# Default: 26\n");
                        writer.write("BLOOM_CHANCE=" + BLOOM_CHANCE + "\n");
                        writer.write("#\n");

                        writer.write("# Chance per random tick for bloomed apple leaves to produce an apple.\n");
            ...
            try (FileReader reader = new FileReader(CONFIG_FILE)) {
                CONFIG.load(reader);
                BLOOM_CHANCE = Integer.parseInt(CONFIG.getProperty("BLOOM_CHANCE", "26"));
